...
crypto_prices = {
    ...
    "TON": 5.2,      # ~$5.2 за TON (актуальная цена декабря 2024)
    "USDT": 1.0
}
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                crypto_prices.update({
                    ...
                    "ETH": 3800,     # ETH ~$3,800
                    "TON": 5.2,      # TON ~$5.2 (актуальная цена)
                    "USDT": 1.0
                })
            ...
            crypto_prices.update({
                ...
                "ETH": 3800,     # $3,800 за ETH
                "TON": 5.2,      # $5.2 за TON (актуальная цена)
                "USDT": 1.0
            })

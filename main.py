...
crypto_prices = {
    ...
    "TON": 1.87,     # исправленная цена TON
    "USDT": 1.0
}
...
def get_crypto_amounts(price_usd):
    """Возвращает суммы для криптовалют с нужной точностью"""
    global crypto_prices
    return {
...
# -------------------- Handlers --------------------
# (handlers остаются без изменений: handle_update, handle_message, handle_callback, handle_successful_payment)
